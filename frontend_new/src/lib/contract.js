...
export const VAULT_ABI = [
  ...
  "function streams(address) view returns (uint256 ratePerSecond, uint256 startTime, uint256 withdrawn)",
...
export function weeklyToRatePerSecond(weeklyUsdt0) {
  // weeklyUsdt0 is a decimal string/number. Returns bigint wei/s.
